...
const LOADING_MESSAGES = [
  'The Chronicler stirs from ancient slumber...',
  'Consulting the records of a thousand betrayals...',
  'Your wound is being transcribed into legend...',
        ...
        <div className="vignette">
          <div className="loading-state">
            <p
              ...
              style={{ fontStyle: 'italic', textAlign: 'center', color: 'crimson' }}
            >
